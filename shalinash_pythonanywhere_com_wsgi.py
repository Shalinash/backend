...
# web application at http://shalinash.pythonanywhere.com/
...
#import sys
#
#path = '/home/shalinash/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/shalinash/mysite/mysite/settings.py'
## and your manage.py is is at '/home/shalinash/mysite/manage.py'
#path = '/home/shalinash/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
# The "/home/shalinash" below specifies your home
# directory -- the rest should be the directory you uploaded your Flask
# code to underneath the home directory.  So if you just ran
# "git clone git@github.com/myusername/myproject.git"
# ...or uploaded files to the directory "myproject", then you should
# specify "/home/shalinash/myproject"
path = '/home/shalinash/mysite/'
if path not in sys.path:
    sys.path.append(path)
